...
def login():
    ...
    elif usernameEntry.get()=='Software' and passwordEntry.get()=='123':
...
usernameLabel=Label(loginFrame, image=usernameImage, text='Usuario', compound=LEFT, font=('times new roman', 20, 'bold'), bg='white')
...
passwordLabel=Label(loginFrame, image=passwordImage, text='Contraseña', compound=LEFT, font=('times new roman', 20, 'bold'), bg='white')
